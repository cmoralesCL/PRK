...
import { ObjetivosAreaPrkCard } from './objetivos-area-prk-card';
...
interface ObjetivosLifePrkSectionProps {
  orbit: Orbit;
  phases: Phase[];
  allPulses?: Pulse[];
...
export function ObjetivosLifePrkSection({
  orbit,
  phases,
  allPulses = [],
  onAddPhase,
            ...
            <div className="flex items-start justify-between gap-2 w-full">
                <div className="flex items-start gap-3 flex-grow text-left">
                    ...
                    <div className='flex-grow'>
                        <h2 className="text-base font-semibold leading-tight text-foreground text-left">
                            {orbit.title}
                        </h2>
