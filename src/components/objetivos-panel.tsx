...
import { ObjetivosLifePrkSection } from './objetivos-life-prk-section';
    ...
    <>
      <main className="flex-1 container mx-auto px-2 sm:px-4 lg:px-6 py-4 overflow-y-auto">
        <div className="flex justify-between items-center mb-4">
            <div>
              <h1 className="text-2xl font-bold font-headline text-foreground">Objetivos</h1>
              <p className="text-sm text-muted-foreground">Define y sigue tus grandes metas de vida.</p>
            </div>
